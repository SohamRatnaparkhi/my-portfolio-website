...
export const THEME_MENU = [
  {
    ...
    image: (
      <Image src="/modes/lightNoBg.png" alt="sun" width={130} height={30} />
    ),
  },
  {
    key: 2,
    ...
    image: (
      <Image src="/modes/nightNoBg.png" alt="night" width={130} height={30} />
    ),
  },
];

export const splashScreenAnimation = (delay: number) => {
  const variants = {
    hidden: {
      scale: 0.8,
      opacity: 0,
